...
DROP TABLE IF EXISTS sales_analysis_report;

CREATE TABLE IF NOT EXISTS sales_analysis_report (
    `Row ID` INT,
...
select * from sales_analysis_report;
...
DELETE FROM sales_analysis_report
